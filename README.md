...
| LLMVault | CTF-based LLM security labs for the OWASP Top 10 (2025. | [LLMVault](https://github.com/CyberSunil/LLMVault) |
...
| 名称                                                         | 时间                                    | 简介                                                         | 链接                                                         |
| ------------------------------------------------------------ | --------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Jailbreaking LLMs' Safeguard with Universal Magic Words for Text Embedding Models | 2025.1.30                               | 发现 text embedding 模型输出分布存在偏斜，利用 bias 方向搜索出通用”魔法词”后缀，可操纵任意文本对的嵌入相似度，绕过基于 RAG 的安全护栏，成功越狱 ChatGPT、DeepSeek、Qwen 等模型，并提出无需重训练的 debiasing 防御方案 | [论文链接](https://arxiv.org/abs/2501.18280) |
| 五大 AI厂商”前沿安全”框架综述<br />【北理工网络空间国际治理研究基地】 | 20250.7                                 | 各大领先AI研究机构纷纷制定前沿模型安全框架，旨在确保当模型达到某些高度危险能力阈值时，能够同步实施足够的安全措施，从而将风险控制在可接受范围内。这些框架是在 2023-2025年间逐步公开的，包括Anthropic的“负责任扩展政策(Responsible Scaling Policy,RSP)”2.2版、OpenAI 的“应对准备框架(PreparednessFramework)”第2版、GoogleDeepMind 的“前沿安全框架(Frontier Safety Framework)”2.0版、Meta 的“以结果为导向的前沿AI框架(Outcomes-Led Frontier Al Framework)”以及Amazon 的“前沿模型安全框架(Frontier Model SafetyFramework)”。 | [文章链接](https://mp.weixin.qq.com/s/E-nUO6Pc-FL2XT3brE6ONA) |
